...
public class customerOrderController {
	...
	@ResponseBody
	public String cancelOrder(@RequestParam("orderproId") Integer productId, @RequestParam("orderId") int orderId,HttpSession session) {
		// Cancelling order in the orderproducts table and updating the status
		custCredModel cust = (custCredModel) session.getAttribute("customer");
		orderdaov.cancelorderbyId(productId, orderId,cust.getCustId());
